...
<main class="bos-main app-store-main">
  ...
  <section class="bos-section">
    ...
    <div class="bos-grid">
      <?=bos_app_card('Beyond Wallet','Spend bit$, review activity and manage your Beyond finances.','beyond-finance/','¤','Open Wallet')?>
      <?=bos_app_card('Beyond Marketplace','Discover and buy creator assets with bit$.','beyond-market/','▦','Open Marketplace')?>
